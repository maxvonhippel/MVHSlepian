...
indeksPlotcoffs1 = repmat(lon, length(1:1890), 1);
indeksPlotcoffs2 = repmat(lat(1:1890)', 1, length(lon));
geoshow(indeksPlotcoffs2, indeksPlotcoffs1, plotcoffsDiff, 'DisplayType', 'texturemap');  
